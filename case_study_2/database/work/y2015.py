...
babur2015a = DB(WorkForward(
    ...
    institution="Technical report 15-01, Dept. of Mathematics and Computer Science, Technische Universiteit Eindhoven, Eindhoven",
    ID="babur2015multiphysics",
    cluster_id="11826893758434149180",
...
badampudi2015a = DB(WorkForward(
    ...
    organization="ACM",
    ID="badampudi2015experiences",
    cluster_id="12066422021541053808",
...
giraldo2015a = DB(WorkForward(
    ...
    entrytype="inproceedings",
    organization="IEEE",
    ID="giraldo2015modelling",
    cluster_id="11566151361657329177",
...
klotins2015a = DB(WorkForward(
    ...
    ID="klotins2015software",
    cluster_id="17734406287758408843",
...
lopez2015a = DB(WorkForward(
    ...
    organization="IEEE",
    ID="lopez2015first",
    cluster_id="14519788416493916704",
...
lopez2015b = DB(WorkForward(
    ...
    cluster_id="13522552218322721099",
...
mendez2015a = DB(WorkForward(
    ...
    place=IACSE,
    entrytype="inproceedings",
    ID="mendez2015automated",
    cluster_id="10594051043388520144",
...
petersen2015a = DB(WorkForward(
    ...
    ID="petersen2015guidelines",
    cluster_id="5808083306683133008",
    scholar="https://scholar.google.com/scholar?cites=5808083306683133008&as_sdt=2005&sciodt=0,5&hl=en",
))
...
rasool2015a = DB(WorkForward(
    ...
    ID="rasool2015review",
    cluster_id="13513340225045196051",
    scholar="http://scholar.google.com/scholar?cites=13513340225045196051&as_sdt=2005&sciodt=0,5&hl=en",
))
