...
april2005a = DB(WorkUnrelated(
    ...
    display="april",
    authors="April, Alain and Huffman Hayes, Jane and Abran, Alain and Dumke, Reiner",
    place=JSEP,
    pp="197--223",
    entrytype="article",
    volume="17",
...
falbo2005a = DB(WorkUnrelated(
    ...
    display="falbo",
    authors="Falbo, RA and Bertollo, Gleidson",
    place=FAKE,
    entrytype="inproceedings",
...
falbo2005b = DB(WorkUnrelated(
    2005, "Establishing a Common Vocabulary for Helping Software Organizations to Understand Software Processes",
    display="falbo b",
    authors="de Almeida Falbo, Ricardo and Bertollo, Gleidson",
    place=FAKE,
    pp="25",
    entrytype="article",
...
frenzel2005a = DB(WorkUnrelated(
    2005, "Ontology-based Architecture to support Software Process Improvement",
    display="frenzel",
    authors="Frenzel, André",
    place=FAKE,
    entrytype="misc",
    publisher="Brandenburg University of Technology Cottbus, Faculty of Mathematics, Natural Science and Computing Internet-Technologies",
