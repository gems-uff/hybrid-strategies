...
bertoa2006a = DB(WorkUnrelated(
    ...
    display="bertoa",
    authors="Bertoa, Manuel F and Vallecillo, Antonio and García, Félix",
    place=FAKE,
    pp="175--196",
    entrytype="incollection",
    publisher="Springer",
    ID="bertoa2006ontology",
    cluster_id="4535880459485815052",
...
biffl2006a = DB(WorkUnrelated(
    ...
    display="biffl",
    authors="Biffl, Stefan and Winkler, Dietmar and Höhn, Reinhard and Wetzel, Herbert",
    place=SPIP,
    pp="229--238",
    entrytype="article",
    volume="11",
    ...
    ID="biffl2006software",
    cluster_id="8376441572406504250",
...
canfora2006a = DB(WorkUnrelated(
    ...
    display="canfora",
    authors="Canfora, Gerardo and García, Félix and Piattini, Mario and Ruiz, Francisco and Visaggio, Corrado Aaron",
    place=FAKE,
    pp="283--304",
    entrytype="article",
    volume="36",
    number="3",
    publisher="Wiley Online Library",
    ID="canfora2006applying",
    cluster_id="1761052978994151267",
...
domínguez2006a = DB(WorkUnrelated(
    ...
    display="domínguez",
    authors="Domínguez, Kenyer and Pérez, P and Mendoza, L and Grimán, Anna",
    place=FAKE,
    entrytype="article",
    volume="9",
    number="1",
    ID="dominguez2006quality",
    cluster_id="11567115697997854788",
    scholar="http://scholar.google.com/scholar?cites=11567115697997854788&as_sdt=2005&sciodt=0,5&hl=en",
    gs2016="1",
...
gonzalez2006a = DB(WorkUnrelated(
    ...
    display="gonzalez",
    authors="Gonzalez-Perez, César and Henderson-Sellers, Brian",
    place=FAKE,
    pp="123--151",
    entrytype="incollection",
    publisher="Springer",
...
montoni2006a = DB(WorkUnrelated(
    ...
    display="montoni",
    authors="Montoni, Mariano and Rocha, Ana Regina and Santos, Gleison and Figueiredo, Sávio and Barreto, Ahilton and Soares, Andréa and Cerdeiral, Cristina and Lupo, Peter",
    place=FAKE,
    entrytype="article",
    publisher="Citeseer",
    ID="montoniprojeto",
...
oliveira2006a = DB(WorkUnrelated(
    ...
    display="oliveira",
    authors="Oliveira, Sandro Ronaldo Bezerra and Vasconcelos, AML and Pereira, José Francisco and Ramos, Igor Cavalcanti",
    place=FAKE,
    entrytype="inproceedings",
    ID="oliveira2006process",
    cluster_id="12186349007393751064",
    scholar="http://scholar.google.com/scholar?cites=12186349007393751064&as_sdt=2005&sciodt=0,5&hl=en",
    gs2016="1",
...
palomäki2006a = DB(WorkUnrelated(
    ...
    place=FAKE,
    entrytype="inproceedings",
    ID="palomaki2006process",
    cluster_id="10442752466228455842",
...
soydan2006a = DB(WorkSnowball(
    ...
    display="soydan",
    authors="Soydan, Gokhan Halit and Kokar, M",
    place=FAKE,
    entrytype="inproceedings",
    organization="Citeseer",
    ID="soydan2006owl",
    cluster_id="9029714520669719868",
    scholar="http://scholar.google.com/scholar?cites=9029714520669719868&as_sdt=2005&sciodt=0,5&hl=en",
