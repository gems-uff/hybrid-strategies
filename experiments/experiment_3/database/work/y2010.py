...
georgieva2010a = DB(WorkUnrelated(
    ...
    display="georgieva",
    authors="Georgieva, Konstantina and Neumann, Robert and Dumke, Reiner R",
    place=FAKE,
    pp="93",
    entrytype="inproceedings",
...
keto2010a = DB(WorkUnrelated(
    ...
    display="keto",
    authors="Keto, Harri and Palomäki, Jari and Jaakkola, Hannu and Pohjoisranta, PO",
    place=FAKE,
    pp="299",
    entrytype="article",
    volume="206",
...
pardo2010a = DB(WorkUnrelated(
    ...
    display="pardo",
    authors="Pardo, César and Pino, Francisco J and García, Félix and Velthius, Mario Piattini and Baldassarre, Maria Teresa",
    place=FAKE,
    pp="61--73",
    entrytype="inproceedings",
    organization="Springer",
...
rodríguez2010a = DB(WorkUnrelated(
    ...
    display="rodríguez",
    authors="Rodríguez, Daniel and Garcia, Elena and Sanchez, Salvador and Nuzzi, Carlos Rodríguez-Solano",
    place=FAKE,
    pp="533--548",
    entrytype="article",
    volume="20",
...
stolfa2010a = DB(WorkSnowball(
    ...
    entrytype="inproceedings",
    organization="IEEE",
    ID="vstolfa2010building",
    cluster_id="10308696375319059085",
    scholar="http://scholar.google.com/scholar?cites=10308696375319059085&as_sdt=2005&sciodt=0,5&hl=en",
    seed_set="1",
    selected_order="4",
    final_selected="1",
    googlescholar2016="1",
