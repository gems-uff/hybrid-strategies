...
alfaraj2011a = DB(WorkUnrelated(
    ...
    display="alfaraj",
    authors="Alfaraj, Hussain M and Qin, Shaowen",
    place=FAKE,
    pp="323--335",
    entrytype="article",
    volume="9",
...
ariely2011a = DB(WorkUnrelated(
    2011, "Boundaries of Socio-Technical Systems and IT for Knowledge Development in Military Environments",
    display="ariely",
    authors="Ariely, Gil-Ad",
    place=FAKE,
    pp="1--14",
    entrytype="article",
    volume="3",
...
azimi2011a = DB(WorkUnrelated(
    2011, "Intelligent look-ahead scheduling for structural steel fabrication projects",
    display="azimi",
    authors="Azimi, Reza and Lee, SangHyun and AbouRizk, Simaan M",
    place=FAKE,
    entrytype="article",
    publisher="Citeseer",
...
carvalho2011a = DB(WorkUnrelated(
    ...
    display="carvalho",
    authors="Carvalho, Daniel D and Costa, A and Sales, E and Lima, A and Reis, R",
    place=FAKE,
    entrytype="article",
...
chen2011a = DB(WorkUnrelated(
    2011, "Analyzing Concurrent Programs Title for Potential Programming Errors",
    display="chen",
    authors="Chen, Qichang and Wang, Liqiang and Guo, Ping and Huang, He",
    place=FAKE,
    pp="380--415",
...
choi2011a = DB(WorkUnrelated(
    2011, "Semantic process management environment",
    display="choi",
    authors="Choi, SeungYoung",
    place=FAKE,
    pp="106--110",
    entrytype="inproceedings",
    organization="IEEE",
...
chrissis2011a = DB(WorkUnrelated(
    ...
    display="chrissis",
    authors="Chrissis, Mary Beth and Konrad, Mike and Shrum, Sandra",
    place=Book,
    entrytype="book",
...
chroust2011a = DB(WorkUnrelated(
    ...
    display="chroust",
    authors="Chroust, Gerhard and Rainer, Karin and Sturm, Nadine and Roth, Markus and Ziehesberger, Peter",
    place=FAKE,
    pp="476--490",
    entrytype="article",
    volume="28",
...
espindola2011a = DB(WorkUnrelated(
    ...
    display="espindola",
    authors="Espindola, Rodrigo Santos de",
    place=FAKE,
    entrytype="article",
...
khurum2011a = DB(WorkUnrelated(
    2011, "Decision support for product management of software intensive products",
    display="khurum",
    authors="Khurum, Mahvish",
    place=Thesis,
    entrytype="phdthesis",
...
klotins2011a = DB(WorkUnrelated(
    2011, "Usability and user experience: measurement model",
    display="klotins",
    authors="Klotins, Eriks",
    place=FAKE,
    entrytype="misc",
...
lane2011a = DB(WorkUnrelated(
    ...
    display="lane",
    authors="Lane, Stephen and Richardson, Ita",
    place=IST,
    pp="424--439",
    entrytype="article",
    volume="53",
...
manjula2011a = DB(WorkUnrelated(
    2011, "A New Framework for Measuring the Quality of Engineering Education System using SEI-CMM approach--(E2-CMM)",
    display="manjula",
    authors="Manjula, R and Vaideeswaran, J",
    place=FAKE,
    pp="28--42",
    entrytype="article",
    volume="2",
...
ribaud2011a = DB(WorkUnrelated(
    2011, "Towards Experience Management for Very Small Entities",
    display="ribaud",
    authors="Ribaud, Vincent and Saliou, Philippe and Laporte, Claude",
    place=FAKE,
    pp="218--230",
    entrytype="article",
    volume="4",
...
rifaut2011b = DB(WorkUnrelated(
    2011, "Compliance management with measurement frameworks",
    display="rifaut b",
    authors="Rifaut, Andre",
    place=FAKE,
    pp="15--24",
...
sharma2011a = DB(WorkUnrelated(
    2011, "Design of experience base model for software process improvement",
    display="sharma",
...
wall2011a = DB(WorkUnrelated(
    2011, "Staying Competitive in the Political Unrest and Global Financial Crisis: Perspective of a Thai Healthcare Organization",
    display="wall",
    authors="Wall, William P",
    place=FAKE,
    pp="336--347",
    entrytype="incollection",
    publisher="IGI Global",
...
weinberger2011a = DB(WorkUnrelated(
    2011, "Semi-Automatic Essay Assessment based on a flexible Rubric",
    display="weinberger",
    authors="Weinberger, Andreas and Dreher, Heinz",
    place=Book,
    entrytype="book",
    publisher="na",
