...
isoiec1998d = DB(WorkUnrelated(
    1998, "Information Technology - Software Process Assessment - Part 7: Guide for Use in Process Improvement",
    display="isoiec d",
    authors="isoiec",
    place=FAKE,
    entrytype="article",
...
mccoy1998a = DB(WorkSnowball(
    ...
    note="cited By 2",
    ID="McCoy19982620",
    scholar="http://scholar.google.com/scholar?cites=18350165022086385221&as_sdt=2005&sciodt=0,5&hl=en",
    organization="IEEE",
